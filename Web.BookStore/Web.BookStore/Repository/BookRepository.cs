...
namespace Web.BookStore.Repository
{
    public class BookRepository
    {
        ...
        public IEnumerable<Book> DataSource()
        {
            ...
            {
                new Book { Id = 101, Title = "MVC", Author = "Sachin", Description="Book description" },
                new Book { Id = 102, Title = "MVC", Author = "Kohli", Description="Book description" },
                new Book { Id = 103, Title = "Dot Net Core", Author = "Rahul", Description="Book description" },
                new Book { Id = 104, Title = "C#", Author = "Sehwag" },
                new Book { Id = 105, Title = "WPF", Author = "Dhoni", Description="Book description" },
